 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'b950d9061598693f2efce7f5856884b1820cd485');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/franck-gaudin/deploy.git');
